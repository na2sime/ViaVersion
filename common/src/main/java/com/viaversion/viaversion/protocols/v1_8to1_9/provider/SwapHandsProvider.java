...
/**
 * Provider for handling swap hands action from 1.9+ clients on 1.8 servers.
 * Platform implementations can override this to fire custom events.
 */
public class SwapHandsProvider implements Provider {

    /**
     * Called when a 1.9+ client sends a swap hands packet (pressing F key).
     *
